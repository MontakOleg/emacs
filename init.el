...
(custom-set-variables
 ...
 '(package-selected-packages
   '(jinx restclient go-mode rainbow-mode git-modes forge cape ejc-sql corfu gptel ob-http ob-swift kotlin-ts-mode editorconfig copilot quelpa-use-package quelpa exec-path-from-shell languagetool markdown-mode vterm embark-consult embark orderless consult marginalia vertico modus-themes wgrep dumb-jump multiple-cursors expand-region evil-nerd-commenter magit helpful yaml-mode swift-mode)))
(custom-set-faces
